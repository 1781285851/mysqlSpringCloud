...
public class WorksController {
    ...
    private @ResponseBody SoftworksResponse<PageInfo> detail(@RequestParam(value = "start") String start,
        ...
        List<Works> worksList = worksService.findByDateService(start, end);
